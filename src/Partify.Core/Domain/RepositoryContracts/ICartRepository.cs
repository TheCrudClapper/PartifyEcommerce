...
public interface ICartRepository
{
    ...
    Task<CartItem?> GetCartItemAsync(int cartId, int offerId, CancellationToken cancellationToken = default);
    ...
    Task<Cart?> GetCartByIdAsync(int cartId, CancellationToken cancellationToken = default);
    ...
    Task<int> GetCartItemsQuantityAsync(int cartId, CancellationToken cancellationToken = default);
    ...
    Task<int?> GetLoggedUserCartIdAsync(Guid userId, CancellationToken cancellationToken = default);
    ...
    Task<CartItem?> GetCartItemWithOfferAsync(int cartItemId, CancellationToken cancellationToken = default);
    ...
    Task<Cart?> GetCartWithAllDetailsAsync(int cartId, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<CartItem>?> GetCartItemsForCostsUpdateAsync(int cartId, CancellationToken cancellationToken = default);
}
