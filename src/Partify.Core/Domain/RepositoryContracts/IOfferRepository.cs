...
public interface IOfferRepository
{
    ...
    Task<Offer?> GetOfferWithDetailsToEditAsync(int id, Guid userId, CancellationToken cancellationToken = default);
    ...
    Task<Offer?> GetOfferByIdAsync(int id, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Offer>> GetOffersByTakeAsync(int take = 12, CancellationToken cancellationToken = default);
    ...
    Task<Offer?> GetUserOfferByIdAsync(int id, Guid userId, CancellationToken cancellationToken = default);
    ...
    Task<Offer?> GetOfferWithAllDetailsByUserAsync(int id, Guid userId, CancellationToken cancellationToken = default);
    ...
    Task<bool> IsOfferInDatabaseAsync(int id, CancellationToken cancellationToken = default);
    ...
    Task<int> GetNonPrivateOfferCount(CancellationToken cancellationToken = default);
}
