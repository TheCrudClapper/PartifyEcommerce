...
public interface IAccountRepository
{
    ...
    Task<bool> IsUserByEmailInDatabaseAsync(string email, CancellationToken cancellationToken = default);
    ...
    Task<ApplicationUser?> GetUserWithAddressAsync(Guid userId, CancellationToken cancellationToken = default);
