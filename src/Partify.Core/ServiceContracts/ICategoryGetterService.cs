...
public interface ICategoryGetterService
{
    ...
    Task<IEnumerable<CardResponse>> GetProductCategoriesAsCardResponse(CancellationToken cancellationToken = default);
    /// <summary>
    ...
    Task<IEnumerable<SelectListItemDto>> GetProductCategoriesAsSelectList(CancellationToken cancellationToken = default);
