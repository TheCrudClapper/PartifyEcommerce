...
public interface ICartService
{
    ...
    Task<Result> AddToCart(int offerId, int quantity = 1, CancellationToken cancellationToken = default);
    ...
    /// <returns>Return Result object identicating Failure or Success</returns>
    Task<Result> DeleteFromCart(int cartItemId, CancellationToken cancellationToken = default);
    ...
    Task<Result<CartResponseDto>> GetLoggedUserCart(CancellationToken cancellationToken = default);

    /// <summary>
    /// Gets current logged user cart id
    /// </summary>
    /// <returns>Returns an int representing user cart id</returns>
    Task<Result<int>> GetLoggedUserCartId(CancellationToken cancellationToken = default);
    ...
    /// <returns></returns>
    Task<Result> UpdateTotalCartValue(int cartId, CancellationToken cancellationToken = default);
    ...
    /// <returns>Return Result object identicating Failure or Success</returns>
    Task<Result> UpdateCartItemQuantity(int cartItemId, int quantity, CancellationToken cancellationToken = default);

    /// <summary>
    /// Counts user items in cart
    /// </summary>
    /// <returns>Returns integer representing amount of items in cart</returns>
    Task<int> GetCartItemsQuantity(CancellationToken cancellationToken = default);
