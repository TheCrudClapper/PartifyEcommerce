...
public interface IAccountService
{
    ...
    Task<Result<AccountResponse>> GetAccount(CancellationToken cancellationToken = default);
    ...
    Task<Result> Edit(AccountUpdateRequest? request, CancellationToken cancellationToken = default);
    ...
    Task<Result> ChangePassword(PasswordChangeRequest? request, CancellationToken cancellationToken = default);
    ...
    Task<Result<AccountDetailsResponse>> GetAccountDetailsAsync(CancellationToken cancellationToken = default);
    ...
    Task<bool> DoesCurrentUserHaveAddress(CancellationToken cancellationToken);
    ...
    Task<bool> IsEmailAlreadyTaken(string email, CancellationToken cancellationToken = default);
}
