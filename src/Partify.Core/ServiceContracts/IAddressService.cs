...
public interface IAddressService
{
    ...
    Task<Result> AddAddress(AddressAddRequest? request, CancellationToken cancellationToken = default);
    ...
    Task<Result<AddressResponse>> GetAddress(int addressId, CancellationToken cancellationToken = default);
    ...
    Task<Result> EditUserAddress(AddressUpdateRequest? request, CancellationToken cancellationToken = default);
    ...
    /// <returns>
    /// </returns>
    Task<Result<AddressResponse>> GetUserAddressForEdit(CancellationToken cancellationToken = default);
    ...
    /// </returns>
    Task<Result<UserAddressDetailsResponse>> GetUserAddressDetails(CancellationToken cancellationToken = default);
}
