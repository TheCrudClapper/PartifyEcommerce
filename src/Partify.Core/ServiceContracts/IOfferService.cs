...
public interface IOfferService
{
    ...
    Task<Result> Add(OfferAddRequest addRequest, CancellationToken cancellationToken = default);
    ...
    /// <returns>Result indicating success or failure.</returns>
    Task<Result> Edit(OfferUpdateRequest updateRequest, CancellationToken cancellationToken = default);
    ...
    Task<Result<OfferResponse>> GetOffer(int id, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<UserOfferResponse>> GetFilteredUserOffers(string? title, CancellationToken cancellationToken = default);
    ...
    /// <returns>Result indicating success or failure.</returns>
    Task<Result> DeleteOffer(int id, CancellationToken cancellationToken = default);
    ...
    Task<Result<EditOfferResponse>> GetOfferForEdit(int id, CancellationToken cancellationToken = default);
    ...
    Task<bool> DoesOfferExist(int id, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<OfferIndexResponse>> GetFilteredOffers(OfferFilter filter, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<CardResponse>> GetIndexPageOffers(CancellationToken cancellationToken = default);

    /// <summary>
    /// Retrieves current deals of the day.
    /// </summary>
    /// <returns>List of offers labeled as deals of the day.</returns>
    Task<IEnumerable<CardResponse>> GetDealsOfTheDay(CancellationToken cancellationToken = default);
}
