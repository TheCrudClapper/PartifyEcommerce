...
public class AccountControllerTests
{
    ...
    public async Task AccountDetails_FailureServiceResult_ReturnsErrorView()
    {
        ...
        _accountController = CreateController();
        _accountController = CreateController();
        _accountServiceMock.Setup(item => item.DoesCurrentUserHaveAddress(CancellationToken.None)).ReturnsAsync(true);
        _accountServiceMock.Setup(item => item.GetAccountDetailsAsync(CancellationToken.None)).ReturnsAsync(Result.Failure<AccountDetailsResponse>(AddressErrors.AddressNotFound));

        //Act
        IActionResult result = await _accountController.AccountDetails(CancellationToken.None);
    ...
    public async Task AccountDetails_SuccessServiceResult_ReturnsView()
    {
        ...
        _accountServiceMock.Setup(item => item.GetAccountDetailsAsync(CancellationToken.None)).ReturnsAsync(Result.Success(accountDetailsResponse));
    ...
    public async Task Edit_FailureServiceResult_ReturnsErrorJson()
    {
        ...
        UserDetailsViewModel viewModel = _fixture.Create<UserDetailsViewModel>();
        _accountController = CreateController();
        _accountServiceMock.Setup(item => item.Edit(It.IsAny<AccountUpdateRequest>(), CancellationToken.None)).ReturnsAsync(Result.Failure(AccountErrors.AccountNotFound));
    ...
    public async Task Edit_SuccessServiceResult_ReturnsErrorJson()
    {
        ...
        UserDetailsViewModel viewModel = _fixture.Create<UserDetailsViewModel>();
        _accountController = CreateController();
        _accountServiceMock.Setup(item => item.Edit(It.IsAny<AccountUpdateRequest>() , It.IsAny<CancellationToken>())).ReturnsAsync(Result.Success);
    ...
    public async Task ChangePassword_FailureServiceResult_ReturnsErrorJson()
    {
        ...
        PasswordChangeRequest viewModel = _fixture.Create<PasswordChangeRequest>();
        _accountController = CreateController();
        _accountServiceMock.Setup(item => item.ChangePassword(It.IsAny<PasswordChangeRequest>(), CancellationToken.None))
